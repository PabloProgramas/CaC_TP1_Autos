...
""" catalogo = Catalogo(host='localhost', user='root', password='lospokes1', database='miapp') """
catalogo = Catalogo(host='lospokes.mysql.pythonanywhere-services.com', user='lospokes', password='uHrDCGg85@Yq886', database='lospokes$miapp')
...
RUTA_DESTINO = '/home/lospokes/mysite/static/imagenes'
